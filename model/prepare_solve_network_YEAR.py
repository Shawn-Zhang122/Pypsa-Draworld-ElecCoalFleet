...
GEN_CSV    = f"data/inputs_{YEAR}/Generator/generators_units.csv"

ONWIND_CSV  = f"data/inputs_{YEAR}/REprofile/ninja_wind_29.0000_120.0000.csv"
OFFWIND_CSV = f"data/inputs_{YEAR}/REprofile/ninja_wind_29.0000_120.0000.csv"
SOLAR_CSV   = f"data/inputs_{YEAR}/REprofile/ninja_pv_29.0000_120.0000.csv"

# Ensure this matches exactly where you saved the file earlier
HYDRO_CSV   = f"data/inputs_{YEAR}/REprofile/artificial_hydro_China_3400hrs.csv"

OTHERS_SETTING_CSV = f"data/inputs_{YEAR}/Others/others_setting.csv"

OUT_PRICE = f"results/prices_{YEAR}_8760.csv"
OUT_FLOW  = f"results/flows_{YEAR}_8760.csv"
